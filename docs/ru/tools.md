...
kommit: 0a1fec2
hesh: 86528fe5c1f843e7b1efe7df94fcd5984270126a4c8f3c267adb3564bef2363a
---
...
| `td_render(path, width, height, save_to, settle_frames)` | Отдаёт вам картинку TOP. `save_to` пишет PNG в файл и отвечает текстом; `settle_frames` сначала ждёт столько кадров TouchDesigner, потому что рендер сразу после правки может показать кадр до неё. |
