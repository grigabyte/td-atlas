...
kommit: 0a1fec2
hesh: ceb69693c7b088a9436e3b69a2a7e19931e53019f767654d06ebaefb8b3f7383
---
...
45 инструментов MCP в трёх группах. `tests/test_skill_reference.py` сверяет
...
| `td_timeline_status(job)` | Ход этого задания: кадр, проход, сохранено N из M, ошибки и `stalled`, когда шаг не шёл несколько секунд. Без `job` — последнее. |
