...
istochnik: README.md
kommit: f0f216a
hesh: 2c839804b36fd13a68ecde29bc3cea908374cb229ab45e5e7a27befdb0cb7f77
---

td-atlas даёт агенту три вещи. Точные имена операторов и параметров *этой*
машины. Правки в запущенной программе, с откатом в один шаг. И способ
...
На macOS и Linux это одна строка из терминала. Установщик написан для
оболочки POSIX, поэтому на Windows идёт последовательность по шагам ниже.
