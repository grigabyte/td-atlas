...
Он задаёт два вопроса: куда клонировать и собирать ли индекс сейчас. У первого
значение по умолчанию `~/td-atlas`. Когда терминала для вопроса нет, он берёт
значение по умолчанию для обоих.

На диске оказываются два каталога: клон, `~/td-atlas`, пока вы не назвали
другой, и `~/.td-atlas`.
