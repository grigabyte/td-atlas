...
<div align="center">
  <img src=".github/td-atlas.png" width="120" alt="Знак td-atlas">
  <h1>td-atlas</h1>
  <p>
...
<!-- Здесь будет скринкаст, когда он снят. Файл кладётся как .github/demo.gif,
     а этот комментарий заменяется на:

     <p align="center"><img src=".github/demo.gif" width="720"
        alt="Агента просят собрать сеть, он строит её в TouchDesigner
             и проверяет, что ничего не умерло молча."></p>

     До тех пор не показывается ничего, чтобы читатель не встретил
     битую картинку. -->
