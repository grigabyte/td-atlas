...
// шаблоном (site/generator/shablon.mjs), что и живой сайт, но на ломтиках старого
...
function instrumenty() {
  ...
  if (vsego !== 46) throw new Error('инструментов ' + vsego + ', ожидалось 46')
  return gruppy
}
...
const KOMMENTARIJ = `  Фикстура пункта 2 раунда 5: канонические страницы замка d1, собранные
  генератором доков (site/generator/sborka.mjs --fixtura) на ломтиках снимка
